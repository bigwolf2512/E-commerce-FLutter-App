...
class UserMainFoodPage extends StatefulWidget {
  const UserMainFoodPage({
    Key? key,
  }) : super(key: key);

  @override
  State<UserMainFoodPage> createState() => _MainFoodPageState();
}

class _MainFoodPageState extends State<UserMainFoodPage> {
  List pages = [
    Container(
      child: FoodPageBody(),
    ),
